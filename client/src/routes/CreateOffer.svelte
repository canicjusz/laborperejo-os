<script>
  ...
  const createNewOffer = () => {
    // newOfferValues.close_at = new Date(newOfferValues.close_at);
    newOfferValues.companyID = companyID;
    newOfferValues.close_at = !newOfferValues.closed
      ? new Date(newOfferValues.close_at)
      : null;
    axios
      .post("/api/offers", newOfferValues)
      .then((res) => navigate(`/ofertoj/${res.data.ID}`));
  };

  //todo: pododawac required do inmpututw
  ...
  <div class="offer">
    ...
    <div class="offer__left">
        ...
        <div class="offer__left-top-text">
          ...
          <span class="offer__company-name">
            <svg
              ...
              /></svg
            >
            {$user.companies[companyIndex].name}
          </span>
      ...
      <div class="offer__left-bottom">
        <Editor
          bind:value={newOfferValues.description}
    ...
    <div class="offer__right">
      ...
      {#if errors.arrangement}<div class="error">{errors.arrangement}</div>{/if}
        ...
        <div>
          {#if !newOfferValues.closed}
            ...
            <input
              ...
              on:change={(e) =>
                (newOfferValues.close_at = new Date(e.target.value))}
      ...
      <div class="button__container">
        <button on:click={checkForm} class="button button--green button--round"
          >Krei</button
        >
      </div>
    </div>
