<script>
  ...
  const sendChanges = () => {
    ...
    if (newImg) {
      ...
      toEdit.avatar = avatarSrc;
    }
    if (newResume) {
      data.append("resume", newResume);
      toEdit.resume = resumeSrc;
    }
    axios
  ...
  <div class="profile">
    <div class="profile__left">
      ...
      <div class="profile__left-bottom">
        <Editor bind:value={toEdit.content} />
      ...
      {#if resumeSrc}
        <object
          ...
          class="resume"
        >
          Pardonon, ni ne povis montri la dosieron ĉi tie. Ne maltrankviliĝu, la
          vivresumo estos videbla ĉe <a href={"/profiloj/" + id} target="_blank"
            >paĝo de via profilo</a
          >.
        </object>
      {/if}
    </div>
  ...
  <div class="profile__right">
    <div class="profile__status">
      <svg
        ...
        /></svg
      >Serĉanta laboron:
      <input type="checkbox" name="" id="" bind:checked={toEdit.searching} />
    </div>
    <div class="profile__job">
      ...
      <input type="text" bind:value={toEdit.job} placeholder="Laborposteno" />
    ...
    <div class="profile__languages">
      ...
      <div>
        ...
        <button on:click={addLanguage} type="button" class="button button--blue"
          >Aldoni novan lingvon</button
        >
        <!-- </div> -->
      </div>
    </div>
